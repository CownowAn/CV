...
\begin{center}
    \textbf{\Huge \scshape Sohyun An} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:821071224425}{+82 10 7122 4425}
    $|$
    \faAt \hspace{.5pt} \href{mailto:sohyunan@kaist.ac.kr}{sohyunan@kaist.ac.kr}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{www.linkedin.com/in/sohyunan0423}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/CownowAn}{GitHub}
    $|$
    \faGlobe \hspace{.5pt} \href{https://cownowan.github.io}{Portfolio}
    $|$
    \faMapMarker \hspace{.5pt} \href{https://goo.gl/maps/y9MPTCy2BoWqx4DU6}{Seoul, South Korea}
\end{center}
